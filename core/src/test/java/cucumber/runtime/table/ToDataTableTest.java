...
public class ToDataTableTest {
    ...
    private static final ParameterInfo PARAMETER_INFO = ParameterInfo.builder(null).setFormat(DD_MM_YYYY).build();
    ...
    public void createTableConverterWithDateFormat() {
        ...
        tc = new TableConverter(xStream, ParameterInfo.builder(null).setFormat(DD_MM_YYYY).build());
    }
